...
//This script creates a customer vip_data.tsv file. It may be used as a template for creating other data files.
	...
	$sql="SELECT week,SUM(purchases) AS purchases FROM weekly_purchases GROUP BY week";
